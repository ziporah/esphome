...
#ifndef _GxEPD2_260_M01_H_
#define _GxEPD2_260_M01_H_
...
class GxEPD2_260_M01 : public GxEPD2_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 152;
    static const uint16_t HEIGHT = 296;
    static const GxEPD2::Panel panel = GxEPD2::GDEW026M01;
    static const bool hasColor = false;
    static const bool hasPartialUpdate = true;
    static const bool hasFastPartialUpdate = true; // set false for extended temperature range
    static const uint16_t power_on_time = 100; // ms, e.g. 60981us
    static const uint16_t power_off_time = 50; // ms, e.g. 39736us
    static const uint16_t full_refresh_time = 3400; // ms, e.g. 3308455us
    static const uint16_t partial_refresh_time = 1000; // ms, e.g. 938384us
    // constructor
    GxEPD2_260_M01();
