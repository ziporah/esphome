...
#ifndef _GxEPD2_154_T8_H_
#define _GxEPD2_154_T8_H_
...
class GxEPD2_154_T8 : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    static const uint16_t power_on_time = 60; // ms, e.g. 54962us
    static const uint16_t power_off_time = 20; // ms, e.g. 19339us
