...
#ifndef _GxEPD2_290_M06_H_
#define _GxEPD2_290_M06_H_
...
class GxEPD2_290_M06 : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    static const uint16_t power_on_time = 100; // ms, e.g. 83946us
    static const uint16_t power_off_time = 50; // ms, e.g. 39163us
