...
#ifndef _GxEPD2_213_B73_H_
#define _GxEPD2_213_B73_H_
...
class GxEPD2_213_B73 : public GxEPD2_EPD
{
  public:
    ...
    static const GxEPD2::Panel panel = GxEPD2::GDEH0213B73;
    static const bool hasColor = false;
    static const bool hasPartialUpdate = true;
    static const bool hasFastPartialUpdate = true;
    static const uint16_t power_on_time = 100; // ms, e.g. 90210us
    static const uint16_t power_off_time = 250; // ms, e.g. 229774us
    static const uint16_t full_refresh_time = 4000; // ms, e.g. 3820212us
    static const uint16_t partial_refresh_time = 200; // ms, e.g. 199006us
    // constructor
    GxEPD2_213_B73();
